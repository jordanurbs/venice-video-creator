...
- [ ] Double-fire guards (double-click Upscale/AI Edit). **Paid — deferred.** The AIEditMenu silent-no-op-when-busy is still a code fix candidate (`Generation/Edit/AIEditMenu.swift`).
