        ...
        AgentTool(
            ...
            inputSchema: objectSchema(
                properties: [
                    ...
                    "referenceAudioMediaRefs": ["type": "array", "items": ["type": "string"], "description": "A single audio asset ID to drive the video's audio_url — lip-sync / scoring for the audio-capable models (Wan 2.5/2.6/2.7, DaVinci MagiHuman; see maxReferenceAudios in list_models). Clips shorter than the model's minimum (Wan 2.7 / MagiHuman require 3s) are auto-padded with trailing silence before upload. Only the first entry is used."],
