                    ...
                    "operations": [
                        ...
                        "items": [
                            ...
                            "properties": [
                                ...
                                "allowMultiShot": ["type": "boolean", "description": "false = never group this shot into a multi-shot generation."],
    ...
    private static func shotSchema() -> [String: Any] {
        [
            ...
            "properties": [
                ...
                "allowMultiShot": ["type": "boolean", "description": "Set false to force this shot to render as its own generation even when multi-shot grouping (Settings → Models) would bundle it with same-scene neighbors. Default true (groupable)."],
