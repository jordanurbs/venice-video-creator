...
final class ToolExecutor {
    ...
    private func run(_ tool: ToolName, _ editor: EditorViewModel, _ args: [String: Any]) async throws -> ToolResult {
        ...
        case .waitForMedia:  return try await waitForMedia(editor, args)
        ...
        case .exportStatus: return try await exportJobStatus(editor, args)
        case .waitForExport: return try await exportJobStatus(editor, args, wait: true)
        case .cancelExport: return try await exportJobStatus(editor, args, cancel: true)
