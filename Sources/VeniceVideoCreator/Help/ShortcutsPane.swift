...
struct ShortcutsPane: View {
    ...
    private static let allShortcuts: [ShortcutGroup] = [
        ...
        ShortcutGroup(title: "Timeline", shortcuts: [
            ...
            ("Cmd + Scroll", "Scroll Timeline Horizontally"),
        ]),
        ShortcutGroup(title: "Media Panel", shortcuts: [
            ("↑ ↓ ← →", "Move Selection"),
            ("Return", "Open Selected Folder"),
        ...
        ShortcutGroup(title: "View & Panels", shortcuts: [
            ("Cmd + 0", "Media Panel"),
            ("Cmd + Opt + 0", "Inspector"),
            ("Cmd + Opt + A", "Agent Panel"),
            ("`", "Maximize Focused Panel"),
            ("Cmd + 1 / 2 / 3", "Layout Presets"),
