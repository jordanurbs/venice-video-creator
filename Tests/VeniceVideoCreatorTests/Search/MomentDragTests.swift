...
struct MomentDragTests {
    ...
    @Test func malformedSegmentsRejected() {
        #expect(MediaTab.assetSegment(fromDragString: "venice-asset://x#5-2") == nil)
        #expect(MediaTab.assetSegment(fromDragString: "venice-asset://x#-1-2") == nil)
        #expect(MediaTab.assetSegment(fromDragString: "venice-asset://x#junk") == nil)
        #expect(MediaTab.assetSegment(fromDragString: "venice-folder://x#1-2") == nil)
        #expect(MediaTab.assetId(fromDragString: "venice-asset://x#junk") == "x")
    }
